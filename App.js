  ...
  return (
    <ScrollView style={{backgroundColor: '#1c1c1c'}}>
      ...
      <View style = {{flexDirection: 'row'}}>
        <Image source={require('./assets/anonymous.png')} style={styles.profile}/>
      ...
      <Text style = {styles.paragraph2}>Hello, I'm Brix Marco Ang, a skilled programmer with a passion for solving complex problems and optimizing system. Im currently a 3rd year student in Global Reciprocal Colleges. , I thrive on tackling challenges head-on and delivering innovative solutions that exceed expectations! So why wait you can hire me.</Text>
      <View style={{flexDirection: 'row'}}>
        <View style={styles.container}>
          ...
          <Text style={styles.paragraph3}>Enter</Text>
        </View>
        <View style={styles.container}>
          <View style = {{flexDirection: 'row'}}>
